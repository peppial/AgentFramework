...
internal static class WorkflowHelper
{
    ...
    private sealed class ConcurrentStartExecutor() :
        Executor<List<ChatMessage>>("ConcurrentStartExecutor"), IResettableExecutor
    {
        /// <summary>
        ...
        /// <summary>
        /// Resets the executor state between workflow runs.
        /// </summary>
        public void Reset()
        {
            // No state to reset for this executor
        }
    }
